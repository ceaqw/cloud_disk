	...
	<div class="function-wrapper">
		...
		<ul class="function-list">
			<li
				...
				:key="index"
			>
                <!--zrx 去除：href和target属性，之前是： :href="item.link" target="_blank"-->
				<a
					class="function-link"
                    href="#"
					title="查看说明文档"
			...
			functionList: [
				{
					...
					title: '多种存储方式',
					desc: '支持本地磁盘、阿里云 OSS 对象存储、FastDFS 存储、MinIO 存储、七牛云 KODO 对象存储',
				...
				},
				{
					...
					title: '多种文件分类 & 查看模式',
					desc: '支持以图片、文档、视频、音乐、其他五种分类查看文件；提供了列表、网格模式，网格模式下支持手动调整图标大小',
